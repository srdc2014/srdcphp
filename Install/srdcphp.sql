...
--
-- 表的结构 `srdcphp_article`
-- 

CREATE TABLE `srdcphp_article` (
...
--
-- 表的结构 `srdcphp_attachment`
-- 

CREATE TABLE `srdcphp_attachment` (
...
--
-- 表的结构 `srdcphp_category`
-- 

CREATE TABLE `srdcphp_category` (
...
--
-- 表的结构 `srdcphp_dbsource`
-- 

CREATE TABLE `srdcphp_dbsource` (
...
--
-- 表的结构 `srdcphp_download`
-- 

CREATE TABLE `srdcphp_download` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `srdcphp_feedback`
-- 

CREATE TABLE `srdcphp_feedback` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `listorder` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- 表的结构 `srdcphp_guestbook`
-- 

CREATE TABLE `srdcphp_guestbook` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL DEFAULT '',
...
--
-- 表的结构 `srdcphp_picture`
-- 

CREATE TABLE `srdcphp_picture` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `userid` int(11) unsigned NOT NULL DEFAULT '0',
  `username` varchar(40) NOT NULL DEFAULT '',
...
--
-- 表的结构 `srdcphp_product`
-- 

CREATE TABLE `srdcphp_product` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `userid` int(11) unsigned NOT NULL DEFAULT '0',
  `username` varchar(40) NOT NULL DEFAULT '',
...
--
-- 表的结构 `srdcphp_role_user`
-- 

CREATE TABLE `srdcphp_role_user` (
...
--
-- 表的结构 `srdcphp_urlrule`
-- 

CREATE TABLE `srdcphp_urlrule` (
...
CREATE TABLE `srdcphp_slide_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `srdcphp_tags_data` (
...
CREATE TABLE `srdcphp_order_data` (
  `id` int(11) unsigned   NOT NULL auto_increment,
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `srdcphp_user_address` (
